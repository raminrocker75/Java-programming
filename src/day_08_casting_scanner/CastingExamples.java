...
//        float-double
        ...
        System.out.println("num9 = " + num9); // 3456.0 cause it added num8 to num9 with decimals because of the data type.
//        shortcuts for println = sout+enter
//        explicit casting
        System.out.println("=======================");
        int num10 = 22;
        ...
        double num15 = 1234.5;
        int num16 = (int)num15; // we lose the decimal points because we cast it to int
